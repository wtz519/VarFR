...
class myModel(nn.Module):
    ...
    def forward(self, x):
        ...
        # print("cat_hidden.shape:", cat_hidden.shape)
        # 分类器
...
# 实例化模型
model1 = myModel(num_hiddens=128, num_layers=2, num_class=20)
...
if __name__ == '__main__':
    ...
    # 模型测试
    print(f"============ 模型测试开始 ============")
    test_model = torch.load("./all_data/model_save/Bytecode_model.pth")
    # 模型验证(评估当前训练模型的性能)
    test_model.eval()
